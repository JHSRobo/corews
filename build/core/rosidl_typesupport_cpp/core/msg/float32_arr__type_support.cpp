...
static const _Float32Arr_type_support_symbol_names_t _Float32Arr_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, core, msg, Float32Arr)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, core, msg, Float32Arr)),
  }
};
...
{
  return &::core::msg::rosidl_typesupport_cpp::Float32Arr_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, core, msg, Float32Arr)() {
  return get_message_type_support_handle<core::msg::Float32Arr>();
}
